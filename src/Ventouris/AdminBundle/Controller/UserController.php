...
namespace Cuaround\AdminBundle\Controller;
...
class UserController extends CRUDController {
    public function approveAction($id) {
        $user = $this->get('doctrine')->getRepository('CuaroundUserBundle:User')->find($id);

        $this->get('cuaround.userservice')->approveCook($user);
